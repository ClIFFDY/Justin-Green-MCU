...
- (32KB)ROM，256B快速寄存器，自拟 16 位总线，MMIO 挂载(12 + 16 KB)RAM、UART (RX FIFO)、Timer、8 位可动态配置 GPIO(支持UART、IN、OUT、IRQ_IN、PWM)
- 硬件中断控制器，支持 4 路外部中断源 (UART/Timer/GPIO1/2)，软中断，可编程中断优先级嵌套，可初始化编程向量表 + IRET 恢复断点
